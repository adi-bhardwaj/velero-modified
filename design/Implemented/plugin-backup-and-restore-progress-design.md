...
Labels will be set with the value returned from `GetValidName` function. (https://github.com/adi-bhardwaj/velero-modified/blob/main/pkg/label/label.go#L35).
...
Plugin need to sanitize the value that can be set for above labels. Label need to be set with the value returned from `GetValidName` function. (https://github.com/adi-bhardwaj/velero-modified/blob/main/pkg/label/label.go#L35).
