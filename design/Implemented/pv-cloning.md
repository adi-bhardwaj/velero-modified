...
In `pkg/restore/restore.go`, around [line 872](https://github.com/adi-bhardwaj/velero-modified/blob/main/pkg/restore/restore.go#L872), Velero has special-case code for persistent volumes.
...
Importantly, the name change will occur **before** [line 890](https://github.com/adi-bhardwaj/velero-modified/blob/main/pkg/restore/restore.go#L890), where Velero checks to see if it should restore the persistent volume.
