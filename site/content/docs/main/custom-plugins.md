...
You will need to give your plugin(s) the full name when registering them by calling the appropriate `RegisterX` function: <https://github.com/adi-bhardwaj/velero-modified/blob/0e0f357cef7cf15d4c1d291d3caafff2eeb69c1e/pkg/plugin/framework/server.go#L42-L60>
...
[2]: https://github.com/adi-bhardwaj/velero-modified/blob/main/pkg/plugin/logger.go
[3]: https://github.com/adi-bhardwaj/velero-modified/blob/main/pkg/restore/restic_restore_action.go
