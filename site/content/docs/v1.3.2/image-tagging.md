...
Velero follows the [Semantic Versioning](http://semver.org/) standard for releases. Each tag in the `github.com/adi-bhardwaj/velero-modified` repository has a matching image, e.g. `velero/velero:v1.0.0`.
