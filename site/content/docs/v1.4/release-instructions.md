...
1.  Run `NEW_DOCS_VERSION=v<major.minor> VELERO_VERSION=v<full-version> make gen-docs` (e.g. `NEW_DOCS_VERSION=v1.2 VELERO_VERSION=v1.2.0 make gen-docs` or `NEW_DOCS_VERSION=v1.2-pre VELERO_VERSION=v1.2.0-beta.1 make gen-docs`).
    - Note that:
        ...
        - **VELERO_VERSION** defines the tag of Velero that any `https://github.com/adi-bhardwaj/velero-modified/...` links in the docs should redirect to.
...
1.  Navigate to the draft GitHub release, at https://github.com/adi-bhardwaj/velero-modified/releases.
