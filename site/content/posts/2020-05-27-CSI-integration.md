...
In the recent [1.4 release of Velero](https://github.com/adi-bhardwaj/velero-modified/releases), we announced a new feature of supporting CSI snapshotting using the [Kubernetes CSI Snapshot Beta APIs](https://kubernetes.io/docs/concepts/storage/volume-snapshots/).
...
- [Velero plugin for CSI snapshots](https://github.com/adi-bhardwaj/velero-modified-plugin-for-csi) for implementation details of the CSI plugin.
