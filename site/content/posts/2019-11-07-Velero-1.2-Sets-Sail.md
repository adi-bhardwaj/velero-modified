...
There are too many new features and improvements to cover in this short blog post. For full details on all of the changes, see the [full changelog](https://github.com/adi-bhardwaj/velero-modified/blob/main/changelogs/CHANGELOG-1.2.md).
