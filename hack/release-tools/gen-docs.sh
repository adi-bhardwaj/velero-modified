...
if [[ $(uname) == "Darwin" ]]; then
    ...
    find $DOCS_DIRECTORY/${NEW_DOCS_VERSION} -type f -name "*.md" | xargs sed -i '' "s|https://github.com/adi-bhardwaj/velero-modified/blob/$MAIN_BRANCH|https://github.com/adi-bhardwaj/velero-modified/blob/$VELERO_VERSION|g"
